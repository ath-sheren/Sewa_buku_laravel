...
<div class="container">
    ...
    @csrf
        <div class="form-group">
            ...
            <input type="hiden" name="tgl_peminjaman" class="form-control" value="{{ date('Y-m-d')}}">
            <input type="hiden" name="tgl_pengembalian" class="form-control" value="{{ date('Y-m-d', strtotime('+15 day', strtotime(date('Y-m-d'))))}}">
        </div> 
        <div class="form-group">
